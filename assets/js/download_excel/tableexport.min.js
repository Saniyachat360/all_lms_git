 ...
 */! function(t, e) {
	...
	var r = function(t, n, o) {
		var s = this;
		s.settings = o ? n : e.extend({}, r.prototype.defaults, n), s.selectors =
		t;
		var a,
		    p,
		    f,
		    ...
		    d = s.settings.emptyCSS instanceof Array ? s.settings.emptyCSS.join(", ") : s.settings.emptyCSS;
		return s.settings.bootstrap ? ( a = r.prototype.bootstrap[0] + " ",
		p = r.prototype.bootstrap[1] + " ",
		f = r.prototype.bootstrap[2] + " ") : ( a = r.prototype.defaultButton + " ",
		p = f = ""), s.selectors.each(function() {
			function t(t) {
			...
			function n(e, n, o) {
				var icon_new=' entypo-download';
				var i = "<button data-fileblob='" + e + "' class='" + a + p + o + icon_new  + "'>" + n + "</button>";
				t(i)
			}
			...
			s.settings.formats.forEach(function(t) {
				!(!i || "xls" !== t) && ( t = "xlsm"), !i && "xlsx" === t && ( t = null), t && v[t](l, b)
			})
	...
	r.prototype = {
			...
			for (var e = {},
				...
				for (var r = 0; r != t[o].length; ++r) {
					...
					if (null != s.v) {
						...
						"number" == typeof s.v ? s.t = "n" : "boolean" == typeof s.v ? s.t = "b" : s.v instanceof Date ? (s.t = "n", s.z = i.SSF._table[14], s.v = this.dateNum(s.v)) : s.t = "s", e[a] =
						s
					}
				}
		...
		export2file : function(t, e, r, s) {
			if (i && ".xls" == s.substr(0, 4)) {
				...
				a.SheetNames.push(r), a.Sheets[r] =
				p;
				var f = {
