...
class Op_cse_productivity_tracker_model extends CI_model {
	function __construct() {
		...
		if ($this -> process_id == 6 || $this -> process_id == 7) {
			...
			f1.date as cse_date,f1.nextfollowupdate as cse_nfd,f1.nextfollowuptime as cse_nftime,f1.comment as cse_comment,
			f2.date as dse_date,f2.nextfollowupdate as dse_nfd,f2.nextfollowuptime as dse_nftime,f2.comment as dse_comment,
			l.enq_id,l.enquiry_for,l.lead_source,l.name,l.contact_no,l.created_date,l.feedbackStatus,l.nextAction,l.assign_to_e_exe as assign_to_dse,l.assign_to_e_tl as assign_to_dse_tl,l.exe_followup_id as dse_followup_id';
	...
	public function lead_assigned_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
	...
	public function lead_assigned($from_date, $to_date, $cse_id) {
	...
	public function home_visit_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function home_visit($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
...
if($this -> process_id ==8){
	...
	public function home_visit_conducted_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function home_visit_conducted($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
	...
	public function home_visit_not_conducted_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function home_visit_not_conducted($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
	...
	public function showroom_visit_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function showroom_visit($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
		...
		public function showroom_visit_conducted_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function showroom_visit_conducted($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
		...
		public function showroom_visit_not_conducted_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function showroom_visit_not_conducted($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
	...
	public function test_drive_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function test_drive($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
	...
	if($this -> process_id ==8){
		...
		return $query -> result();
			...
			public function test_drive_conducted_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function test_drive_conducted($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
		...
		public function test_drive_not_conducted_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function test_drive_not_conducted($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
	...
	public function evaluation_allotted_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function evaluation_allotted($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
	...
	public function evaluation_conducted_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function evaluation_conducted($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
		...
		return $query -> result();
			...
			public function evaluation_not_conducted_count($from_date, $to_date, $cse_id) {
		$today = date('Y-m-d');
		$this -> db -> select('count(distinct l.enq_id) as count_lead');
	...
	public function evaluation_not_conducted($from_date, $to_date, $cse_id) {
		ini_set('memory_limit', '-1');
