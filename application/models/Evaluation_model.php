...
class Evaluation_model extends CI_model {
	...
	public function downloadLeads() {
		...
		if($role=1 && $getUserid == ''){
				$where="((f2.appointment_type='Evaluation Allotted' and f2.appointment_date='". $this->today ."')or(f1.appointment_type='Evaluation Allotted' and f1.appointment_date='". $this->today."'))";
			$this -> db -> where($where);
		}
