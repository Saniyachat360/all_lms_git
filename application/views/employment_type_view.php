...
<div class="row" >
	...
	if($insert[5]==1)
	{?>
	<h1 style="text-align:center; ">Add Employment Type</h1>
	<div class="col-md-12" >
				...
				<form action="<?php echo $var; ?>" method="post">
					<div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
						<div class="col-md-12">
								...
								<div class="form-group">
								<label class="control-label col-md-2 col-sm-4 col-xs-12" for="first-name">Employment Type: </label>
								<div class="col-md-8 col-sm-5 col-xs-12">
		...
		<div class="table-responsive"  >
			...
			<tbody>
				...
				<tr>
					...
					<?php if($modify[5]==1) {
					?>
					<a href="<?php echo site_url(); ?>employment_type/edit_l_status/<?php echo $fetch -> e_id; ?>">Edit </a> &nbsp;&nbsp;
					<?php }
						if($delete[5]==1) {
					?>
					<a onclick="return getConfirmation();" href="<?php echo site_url(); ?>employment_type/delete_l_status/<?php echo $fetch -> e_id; ?>">Delete </a>
					<?php } ?>
					</td>
					<?php }
					} ?>
