...
<script>
					...
					function select_type()
		{
			...
			$.ajax({
				url:'<?php echo site_url('assign_leads/select_type')?>',
				type:'POST',
			...
			?>
								...
								<div class="col-md-6">
									...
									<label class="control-label col-md-3 col-sm-3 col-xs-4" for="first-name">
										 Type </label>
									<div class="col-md-9 col-sm-9 col-xs-8">
										<select name="lead_type" id="lead_type" class="form-control" required onchange="select_type()">
                     <option value="1">Lead Source</option>
                     <option value="3">Facebook Campaigns</option>
