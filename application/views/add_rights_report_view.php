...
<script >
  ...
  function checkUser1()
  {
  		...
  		$.ajax({url: "<?php echo site_url(); ?>add_rights_report/checkUser",
		type:"POST",
  ...
  var username=document.getElementById("username").value;
	...
	$.ajax({
    			url : '<?php echo site_url('add_rights_report/checkRights'); ?>',
 ...
 // alert(username);
  		$.ajax({
    		url : '<?php echo site_url('add_rights_report/cpyright'); ?>',
...
if($insert[8]==1)
{?>
<h1 style="text-align:center; ">Add Report Rights</h1>
	<div class="col-md-12" >
