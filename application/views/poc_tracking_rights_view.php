...
<script >
   ...
   function checkRights()
  {
	...
	$.ajax({
    			url : '<?php echo site_url('add_right/checkPOCTrackingRights'); ?>',
   ...
   function cpypocTRights()
  {
  	
  	var cpyuser=document.getElementById("cpypocTright").value;
  	var username=document.getElementById("username").value;
 	
  	if(cpyuser==''){
  		alert("Please Select User For Copy User Rights");
  		return false();
  	}
 ...
 // alert(username);
  		$.ajax({
    		url : '<?php echo site_url('add_right/cpypocTright'); ?>',
...
if($insert[8]==1)
{?>
<h1 style="text-align:center; ">Add POC Purchase Tracking Rights</h1>
	<div class="col-md-12" >
