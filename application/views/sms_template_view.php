...
<div class="row" >
	...
	if($insert[5]==1)
	{?>
	<h1 style="text-align:center; ">Add SMS Template</h1>
	<div class="col-md-12" >
			...
			<div class="panel-body">
				<form action="<?php echo $var; ?>" method="post" enctype="multipart/form-data">
                  ...
                  autocomplete="off" class="form-control" >
							...
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">SMS Type: </label>
								<div class="col-md-5 col-sm-5 col-xs-12">
								...
								<div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Header: </label>
								<div class="col-md-5 col-sm-5 col-xs-12">
								<input type="text" id="header" placeholder="Enter Header"  name="header" 
                  autocomplete="off" class="form-control" >
								</div>
							</div>
								<div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Approved: </label>
								<div class="col-md-5 col-sm-5 col-xs-12">
								<input type="checkbox" id="approved"  name="approved"   autocomplete="off" class="form-control" >
								</div>
							</div>
								...
								<div class="col-md-5 col-sm-5 col-xs-12">
							 <textarea id="product_description" name="product_description" rows="10" cols="80" required>
...
<div class="row" >
	...
	//	print_r($delete);
        ...
        if(isset($modify[5]))
        {if($modify[5]==1){?>
                <a href="<?php echo site_url(); ?>/sms_template/template_edit/<?php echo $row ->t_id; ?>">Edit </a>
                <?php }  } ?> &nbsp;&nbsp; 
                <?php if(isset($delete[5])){
                if($delete[5]==1){?>
                <a onclick="return getConfirmation()" href="<?php echo site_url(); ?>/sms_template/template_delete/<?php echo $row ->t_id; ?>">Delete </a>
                 <?php }  } ?>
          <?php }
      else
      {
            ?>
            <a onclick="return getActionConfirmation()" href="<?php echo site_url(); ?>/sms_template/template_action/<?php echo $row ->t_id; ?>">Active</a> &nbsp;&nbsp;
            <?php
      }
    ?></td>
