...
-->
						...
						<tr>
							...
							<td><input type="checkbox" class="checkbox pull-right" name="update_payment_details_view" value="1">

								<input type="hidden" name="update_payment_details_view1"   value="0">

							</td>

							<td><input type="checkbox" class="checkbox1 pull-right" name="update_payment_details_insert" value="1">
