...
<div class="table-responsive">
						...
						<tr>
							...
							<td><input type="checkbox" class="checkbox1 pull-right" name="lead_report_insert" value="1">
								<input type="hidden" class="checkbox" name="lead_report_insert1" value="0">
							</td>
							<td><input type="checkbox" class="checkbox2 pull-right" name="lead_report_modify" value="1">
								<input type="hidden" class="checkbox2" name="lead_report_modify1" value="0">
							</td>
							<td><input type="checkbox" class="checkbox3 pull-right" name="lead_report_delete" value="1">
					...
					<!--	<tr>
						...
						<tr>
							...
							<td><input type="checkbox" class="checkbox pull-right" name="flogin_status_view" value="1">
								<input type="hidden" name="flogin_status_view1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox1 pull-right" name="flogin_status_insert" value="1">
								<input type="hidden" name="flogin_status_insert1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox2 pull-right" name="flogin_status_modify" value="1">
								<input type="hidden" name="flogin_status_modify1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox3 pull-right" name="flogin_status_delete" value="1">
						...
						<tr>
							...
							<td><input type="checkbox" class="checkbox pull-right" name="freject_reason_view" value="1">
								<input type="hidden" name="freject_reason_view1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox1 pull-right" name="freject_reason_insert" value="1">
								<input type="hidden" name="freject_reason_insert1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox2 pull-right" name="freject_reason_modify" value="1">
								<input type="hidden" name="freject_reason_modify1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox3 pull-right" name="freject_reason_delete" value="1">
							...
							<td><input type="checkbox" class="checkbox pull-right" name="fdocument_view" value="1">
								<input type="hidden" name="fdocument_view1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox1 pull-right" name="fdocument_insert" value="1">
								<input type="hidden" name="fdocument_insert1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox2 pull-right" name="fdocument_modify" value="1">
								<input type="hidden" name="fdocument_modify1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox3 pull-right" name="fdocument_delete" value="1">
						...
						<tr>
							...
							<td><input type="checkbox" class="checkbox pull-right" name="fscript_view" value="1">
								<input type="hidden" name="fscript_view1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox1 pull-right" name="fscript_insert" value="1">
								<input type="hidden" name="fscript_insert1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox2 pull-right" name="fscript_modify" value="1">
								<input type="hidden" name="fscript_modify1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox3 pull-right" name="fscript_delete" value="1">
							...
							<td><input type="checkbox" class="checkbox pull-right" name="fscheme_view" value="1">
								<input type="hidden" name="fscheme_view1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox1 pull-right" name="fscheme_insert" value="1">
								<input type="hidden" name="fscheme_insert1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox2 pull-right" name="fscheme_modify" value="1">
								<input type="hidden" name="fscheme_modify1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox3 pull-right" name="fscheme_delete" value="1">
							...
							<td><input type="checkbox" class="checkbox pull-right" name="femp_type_view" value="1">
								<input type="hidden" name="femp_type_view1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox1 pull-right" name="femp_type_insert" value="1">
								<input type="hidden" name="femp_type_insert1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox2 pull-right" name="femp_type_modify" value="1">
								<input type="hidden" name="femp_type_modify1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox3 pull-right" name="femp_type_delete" value="1">
							...
							<td><input type="checkbox" class="checkbox pull-right" name="fprof_type_view" value="1">
								<input type="hidden" name="fprof_type_view1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox1 pull-right" name="fprof_type_insert" value="1">
								<input type="hidden" name="fprof_type_insert1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox2 pull-right" name="fprof_type_modify" value="1">
								<input type="hidden" name="fprof_type_modify1"   value="0">
							</td>
							<td><input type="checkbox" class="checkbox3 pull-right" name="fprof_type_delete" value="1">
