...
<!-- To Display the inser update message after inserting and updating the data in table -->
<div class="col-md-12"> <?php echo $this->session->flashdata('message'); ?> </div>

  <div class="row" >
	<h1 style="text-align:center; ">Dashboard <a href="<?php echo site_url(); ?>break_time"><button id="showPopupBtn" style="float:right; margin-right:2%;" class="btn btn-success col-md-1">Break Time</button></a></h1>
	<div class="col-md-12" >
		...
		//Create Loader
					src1 ="<?php echo base_url('assets/images/loader200.gif'); ?>";
						...
						<?php if($this->session->userdata('process_id')==9){
							$ajaxurl=site_url()."Notification/all_notification_complaint_counts";
						}else{
							$ajaxurl= site_url()."Notification/all_notification_counts";
						}
						?>
