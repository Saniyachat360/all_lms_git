...
<h1 style="text-align:center; ">CSE Wise Report</h1>
...
<div class="col-md-12">
    <div class="panel panel-primary">
        <div class="panel-body">
            <form action="<?php echo site_url(); ?>Cse_wise_report/cse_wise_report" id="filterForm" method="POST">
                <div class="form-group col-md-12">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding: 20px;">
                        <select class="filter_s col-md-12 col-xs-12 form-control" name="cse_name" id="cse_name" placeholder="Please Select Cse User">
                            <option value="">Please Select Cse User</option>
                            <?php foreach ($cse_users as $cse_user) : ?>
                                <option value="<?php echo $cse_user['id']; ?>"><?php echo $cse_user['cse_name']; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding: 20px;">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#filterForm').submit(function(e) {
            ...
            if (!cse_name) {
                toastr.error('Please select cse user.');
                $('#loader').hide();
                return;
            }
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url(); ?>Cse_wise_report/filterSubmissionProcesses',
                data: $(this).serialize(),
                dataType: 'json',
        ...
        $('#Downloads').click(function() {
            ...
            XLSX.writeFile(wb, 'Cse_Report.xlsx');
        });
    });
