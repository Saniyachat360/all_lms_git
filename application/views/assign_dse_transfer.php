...
<script>
	...
	document.getElementById("leadsdiv").style.display='none';
			$.ajax({
				url:'<?php echo site_url('assign_dse_transfer/select_fromuser')?>',
				type:'POST',
		...
		document.getElementById("leadsdiv").style.display='block';
			$.ajax({
				url:'<?php echo site_url('assign_dse_transfer/checkLeads')?>',
				type:'POST',
					...
					function select_touser()
		{
			...
			{
				$.ajax({
				url:'<?php echo site_url('assign_dse_transfer/select_touser')?>',
				type:'POST',
	...
	<?php
		...
		<div class="col-md-12" >
			<div class="panel panel-primary">
				...
				<div class="col-md-9 col-sm-9 col-xs-8">
					<select name="fromUser" id="fromUser" class="form-control" required >
                      <option value="">Please Select</option>
					</select>
			</div>
			</div>
