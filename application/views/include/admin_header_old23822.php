				...
				?>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							{
							if(($view[30]==1 || $view[66]==1)  &&  $_SESSION['process_id'] ==7){	?>
							<li>
...
if(isset($_SESSION['cross_lead_user']))
 ...
 ?>
					...
					<a href="<?php echo site_url(); ?>New_car_stock/with_model"><span class="title">New Car Stock</span></a>
							...
							<li class="divider"></li>
								<li>
								<a href="<?php echo site_url(); ?>login_history_controller"><span class="title">Login History</span></a>
							</li>
							
							<li class="divider"></li>
								<li>
								<a href="<?php echo site_url(); ?>loan"><span class="title">Loan Type</span></a>
							</li>
								<li class="divider"></li>
								<li>
								<a href="<?php echo site_url(); ?>scripts"><span class="title">Script</span></a>
							</li>
								<li class="divider"></li>
								<li>
								<a href="<?php echo site_url(); ?>login_status"><span class="title">Login Status</span></a>
							</li>
								<li class="divider"></li>
								<li>
								<a href="<?php echo site_url(); ?>reject_reason"><span class="title">Reject Reason</span></a>
							</li>
							<li class="divider"></li>
								<li>
								<a href="<?php echo site_url(); ?>employment_type"><span class="title">Employment Type</span></a>
							</li>
							<li class="divider"></li>
								<li>
								<a href="<?php echo site_url(); ?>professional_type"><span class="title">Professional Type</span></a>
							</li>
								<li class="divider"></li>
								<li>
								<a href="<?php echo site_url(); ?>document"><span class="title">Map Document</span></a>
							</li>
								<li class="divider"></li>
								<li>
								<a href="<?php echo site_url(); ?>scheme"><span class="title">Scheme</span></a>
							</li>
						</ul>
					</li>
