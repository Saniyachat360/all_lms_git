...
<head>
	...
	<link rel="icon" href="<?php echo base_url(); ?>assets/images/fevicon.jpeg">
	<style>
		.marginBottom-0 {
			margin-bottom: 0;
		}
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					<div class="form-group" style="margin-top: 12px;margin-bottom: 0px; margin-right: 7px;">
						...
						<?php if ($header_process_id == 1 && $header_process_name == 'Finance'): ?>
							<option value="<?php echo $header_process_id; ?>">Loankaro</option>
						<?php elseif(in_array($header_process_id, [4, 5, 6, 7, 8, 9, 10]) && $header_process_name == 'Finance'): ?>
							<option value="<?php echo $header_process_id; ?>">Loankaro</option>
						<?php else: ?>
						...
						<?php endif; ?>						<?php
							...
							SELECT p.process_id, 
								   CASE WHEN p.process_name = 'Finance' THEN 'Loankaro' ELSE p.process_name END AS process_name
							FROM lmsuser l 
							LEFT JOIN tbl_manager_process mp ON mp.user_id = l.id 
							LEFT JOIN tbl_process p ON p.process_id = mp.process_id
							WHERE mp.user_id = '$header_user_id' AND mp.process_id != '$header_process_id' 
							GROUP BY p.process_id 
							ORDER BY FIELD(p.process_id, '6', '7', '8', '9', '1', '4', '5', '10')
						")->result();
				...
				$tracker_array = array(6 => 13, 7 => 28, 1 => 38, 4 => 46, 5 => 54, 8 => 74,10=>56);
				$new_lead_array = array(6 => 1, 7 => 22, 1 => 32, 4 => 40, 5 => 48, 8 => 68,10=>56);
				$assign_lead_array = array(6 => 4, 7 => 23, 1 => 33, 4 => 41, 5 => 49, 8 => 69,10=>56);
				$assign_transferred_lead_array = array(6 => 17, 7 => 24, 1 => 34, 4 => 42, 5 => 50, 8 => 70,10=>56);
				...
				<?php
				if ($this->session->userdata('role') == 2 && $this->session->userdata('user_id') == 31) { ?>
					<li class="dropdown">
						<?php if ($header_process_id == 6) { ?>
							<a href="<?php echo site_url(); ?>dashboard_dse">Dashboard DSE</a>
						<?php }  ?>
					<?php } ?>
					</li>
						...
						<li class="dropdown">
							...
							{ 
								*/
								...
								<!-- Report Count -->
								<?php $logged_in_user_id = $this->session->userdata('role_name');
								$allowed_user_ids = array('Admin', 'Manager');
								if (!empty($logged_in_user_id) && in_array($logged_in_user_id, $allowed_user_ids)) : ?>
									<li class="dropdown dropdown-submenu">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown">Report Count</a>
										<ul class="dropdown-menu">
											<li><a href="<?php echo site_url(); ?>source/source_view"><span class="title">Source</span></a></li>
											<li class="divider"></li>
											<li>
												<a href="<?php echo site_url(); ?>campaign_wise/campaign_view"><span class="title">Campaign</span></a>
											</li>
											<li class="divider"></li>
											<li>
												<a href="<?php echo site_url(); ?>Cse_wise_report/cse_wise_report"><span class="title">CSE</span></a>
											</li>
											<li class="divider"></li>
											<li>
												<a href="<?php echo site_url(); ?>Dse/dse_view"><span class="title">DSE</span></a>
											</li>
											<li class="divider"></li>
											<li>
												<a href="<?php echo site_url(); ?>Location_wise/location_wise_report"><span class="title">Location</span></a>
											</li>
										</ul>
									</li>
									<li class="divider"></li>
								...
								<?php if (($view_report[5] == 1  && $header_process_id == 6) || ($view_report[15] == 1 && $header_process_id == 7) || ($view_report[6] == 1  && $header_process_id == 6) || ($view_report[16] == 1 && $header_process_id == 7) || ($view_report[25] == 1  && $header_process_id == 8) || ($view_report[26] == 1 && $header_process_id == 8)) {  ?>
									<li class="dropdown dropdown-submenu">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown">Dashboard Reports</a>
										<ul class="dropdown-menu">
											...
											<?php if (isset($view_report[5]) && isset($view_report[15]) && isset($view_report[25])) {
												if (($view_report[5] == 1  && $header_process_id == 6) || ($view_report[15] == 1 && $header_process_id == 7) || ($view_report[25] == 1 && $header_process_id == 8)) { ?>
													<li>
														<a href="<?php echo site_url(); ?>notification_test_drive"><span class="title">Test Drive</span></a>
													</li>
													<li class="divider"></li>
											<?php }
											} ?>
											...
											<?php if (isset($view_report[5]) && isset($view_report[15]) && isset($view_report[25])) {
												if (($view_report[5] == 1  && $header_process_id == 6) || ($view_report[15] == 1 && $header_process_id == 7) || ($view_report[25] == 1 && $header_process_id == 8)) { ?>
													<li>
														<a href="<?php echo site_url(); ?>notification_home_visit">Home Visit</a>
													</li>
													<li class="divider"></li>
											<?php }
											} ?>
											...
											<?php if (isset($view_report[5]) && isset($view_report[15]) && isset($view_report[25])) {
												if (($view_report[5] == 1  && $header_process_id == 6) || ($view_report[15] == 1 && $header_process_id == 7) || ($view_report[25] == 1 && $header_process_id == 8)) { ?>
													<li>
														<a href="<?php echo site_url(); ?>notification_showroom_visit"><span class="title">Showroom Visit</span></a>
													</li>
													<li class="divider"></li>
											<?php }
											} ?>
											...
											<?php if (isset($view_report[5]) && isset($view_report[15]) && isset($view_report[25])) {
												if (($view_report[5] == 1  && $header_process_id == 6) || ($view_report[15] == 1 && $header_process_id == 7) || ($view_report[25] == 1 && $header_process_id == 8)) { ?>
													<li>
														<a href="<?php echo site_url(); ?>notification_evaluation"><span class="title">Evaluation</span></a>
													</li>
													<li class="divider"></li>
											<?php }
											} ?>
							    ...
							    <!-- Break Time Reports -->
								<?php if (isset($view_report[30]) && isset($view_report[31]) && isset($view_report[32])) {
									if (($view_report[30] == 1  && $header_process_id == 6) || ($view_report[31] == 1 && $header_process_id == 7) | ($view_report[32] == 1 && $header_process_id == 8)) { ?>
										<li><a href="<?php echo site_url(); ?>break_reports">Break Time Report</a></li>
								<?php }
								} ?>
								<li class="divider"></li>

								<!-- Login Logout Reports -->
								<?php if (isset($view_report[33]) && isset($view_report[34]) && isset($view_report[35])) {
									if (($view_report[33] == 1  && $header_process_id == 6) || ($view_report[34] == 1 && $header_process_id == 7) | ($view_report[35] == 1 && $header_process_id == 8)) { ?>
										<li><a href="<?php echo site_url(); ?>login_out_report/users">Login Logout Report</a></li>
								<?php }
								} ?>
							</ul>
						</li>
				...
				<?php
				if (($header_process_id == 8 && $_SESSION['sub_poc_purchase'] == 1) || $header_process_id == 6 || $header_process_id == 7 ||  $header_process_id == 4 || $header_process_id == 5) {
				...
				<?php
				//print_r($view);
				if ($view[0] == 1 || $view[2] == 1 || $view[3] == 1 || $view[5] == 1 || $view[6] == 1 || $view[7] == 1 || $view[8] == 1 || $view[14] == 1 || $view[20] == 1) {
					//|| $view[62]==1

					if (!empty($this->session->userdata('view_finance'))) {
						$view_finance = $this->session->userdata('view_finance');
					} else {

						$view_finance = '';
					}
					//print_r($view_finance);
				?>
						...
						<ul class="dropdown-menu">
							...
							<?php if ($view_finance != '') {	?>
								<li class="dropdown dropdown-submenu">
									...
									<ul class="dropdown-menu" style='top: -107px;'>
										<?php if (isset($view_finance[0])) {
											if ($view_finance[0] == 1) {	?>
												<li> <a href="<?php echo site_url(); ?>login_status"><span class="title">Login Status</span></a></li>
												<li class="divider"></li>
										<?php }
										} ?>
										<?php if (isset($view_finance[1])) {
											if ($view_finance[1] == 1) {	?>
												<li> <a href="<?php echo site_url(); ?>reject_reason"><span class="title">Reject Reason</span></a></li>
												<li class="divider"></li>
										<?php }
										} ?>
										<?php if (isset($view_finance[2])) {
											if ($view_finance[2] == 1) {	?>
												<li> <a href="<?php echo site_url(); ?>document"><span class="title">Map Document</span></a>
												<li class="divider"></li>
										<?php }
										} ?>
										<?php if (isset($view_finance[3])) {
											if ($view_finance[3] == 1) {	?>
												<li> <a href="<?php echo site_url(); ?>scripts"><span class="title">Script</span></a></li>
												<li class="divider"></li>
										<?php }
										} ?>
										<?php if (isset($view_finance[4])) {
											if ($view_finance[4] == 1) {	?>
												<li><a href="<?php echo site_url(); ?>scheme"><span class="title">Scheme</span></a></li>
												<li class="divider"></li>
										<?php }
										} ?>
										<?php if (isset($view_finance[5])) {
											if ($view_finance[5] == 1) {	?>
												<li> <a href="<?php echo site_url(); ?>employment_type"><span class="title">Employment Type</span></a></li>
												<li class="divider"></li>
										<?php }
										} ?>
										<?php if (isset($view_finance[6])) {
											if ($view_finance[6] == 1) {	?>
												<li> <a href="<?php echo site_url(); ?>professional_type"><span class="title">Professional Type</span></a></li>
							...
							?>
								<li>
									<a href="<?php echo site_url(); ?>Service_center"><span class="title">Add Service Center</span></a>
								</li>
								<li class="divider"></li>
							<?php } ?>
							...
							?>
								<li>
									<a href="<?php echo site_url(); ?>Service_type"><span class="title">Add Service Type</span></a>
								</li>
								<li class="divider"></li>
							<?php } ?>
							...
							?>
									<li>
										<a href="<?php echo site_url(); ?>add_call_center_tl/auto_assign"><span class="title">Lead Auto Assign</span></a>
				...
				if (isset($_SESSION['cross_lead_user'])) {
					if ($_SESSION['cross_lead_user'] == 1) { ?>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li>
									<a href="<?php echo site_url(); ?>sign_up/dashboard"><span class="title">Dashboard</span></a>
								</li>
								<li class="divider"></li>
								<li>
							...
							{*/ ?>
								...
								<li>
									<a href="<?php echo site_url(); ?>sign_up/all_lead"><span class="title">Cross Lead Listing</span></a>
								</li>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						?>
						<?php
						// if (isset($view[85]) || ($this->session->userdata('role') == 1) && $header_process_id == 6) {
						// 	if ($view[85] == 1  || ($this->session->userdata('role') == 1)) {
						if (isset($view[85])) {
							if ($view[85] == 1) {
						?>
								<li>
									<a href="<?php echo site_url(); ?>add_payment_booking"><span class="title">Booking Payment</span></a>
								</li>
				...
				<!-- New Report -->
					 <?php if($this->session->userdata('process_id')== 1){ ?>
					<li class="dropdown">
					<a data-toggle="dropdown" class="dropdown-toggle" href="#">New Report <b class="caret"></b></a>
					<ul class="dropdown-menu">
								<li>
									<a href="<?php echo site_url(); ?>Call_Status"><span class="title">Call Status Report</span></a>
								</li>
								<li class="divider"></li>
							<li>
								<a href="<?php echo site_url(); ?>Loan_product_type"><span class="title">Loan Type Report</span></a>
							</li>
							<li class="divider"></li>
							<li>
								<a href="<?php echo site_url(); ?>Bank"><span class="title">Case Count x Bank Report</span></a>
							</li>
							<li class="divider"></li>					
							<li>
								<a href="<?php echo site_url(); ?>CallerNameWise"><span class="title">Caller Wise Report</span></a>
							</li>
							<li class="divider"></li>				
					</ul>
				</li>
