			...
			?>	
						 ...
						 if(isset($view[64]))
							{
								if(($view[64]==1)) { ?>
								<li>
									<a href="<?php echo site_url(); ?>dse_daily_reporting">Add Daily Report</a>
								</li>
								<li class="divider"></li>
								<?php } 
							} 
							if(isset($view[65]))
							{
								if(($view[65]==1))	{ 	 ?>
								<li>
									<a href="<?php echo site_url(); ?>dse_daily_reporting/show_data">DSE Daily Report</a>
								</li>
								<?php } 
							}
						} ?>
					...
					if(($header_process_id==6 ||$header_process_id==7 || $header_process_id==8)  && ($header_role==1 || $header_role==2))
					{
						...
						<li><a href="<?php echo site_url(); ?>reports/lead_sourcewise">Source Wise</a></li>
							<li class="divider"></li>
						<li><a href="<?php echo site_url(); ?>one_pager_report">One Pager Report</a></li>
						<li class="divider"></li>
