...
$(document).ready(function() {
		//alert(new Date());
		$('#followupdate,#appointment_date').daterangepicker({
...
$.ajax({
	...
	$.ajax({
	url : '<?php echo site_url('add_followup_used_car/select_model'); ?>',
		type : 'POST',
		data : {'make' : make,},
		success : function(result) {
	...
	if(budget_from=='' && budget_to=='' && make=='' && model=='0')
	{
		...
		//alert("No Vehicle Found");
			...
			$.ajax({
			url : '<?php echo site_url('add_followup_used_car/select_model_budget'); ?>',
				type : 'POST',
				data : {'budget_from' : budget_from,'budget_to' : budget_to, 'make': make, 'model': model},
				success : function(result) {
				$("#model_div_budget").html(result);
				}
				});
				}
	}
	...
	var make = document.getElementById("buy_make").value;
	$.ajax({
	url : '<?php echo site_url('add_followup_used_car/select_buy_model'); ?>',
		type : 'POST',
		data : {'make' : make,},
		success : function(result) {
	 ...
	 if(alternate_contact == '')
		...
		document.getElementById("alternate_contact").value = alternate_contact;
			...
			<?php if((isset($insert[79]) && $_SESSION['process_id']==7))
				  { 
				  	if($insert[79] == '1') {?>
	 if(appointment_type == '' || appointment_type == 'null')
			{
...
<div class="col-md-12">
           ...
           <div class="col-md-3">
                     ...
                     <p> <b style="font-size: 13px;">Name: </b> <?php echo $lead_detail[0] -> name; ?></p>
                     	<?php if($lead_detail[0]->comment!=''){?>
     					<p>
     						<b style="font-size: 15px;">comment: </b><?php echo $lead_detail[0]->comment; ?>
     					</p>
     					<?php } ?>
     					</div>
     				<div class="col-md-6" style="margin-top:20px;">   
         	<div class="col-md-8"><b style="font-size: 13px;">Contact: </b><?php echo $lead_detail[0] -> contact_no; ?></div>
 	 ...
 	 <div class="panel panel-primary">
     	<div class="panel-body">
     		<form action="<?php echo $var; ?>" method="post">
                         		...
                         		<div class="col-md-4">
                         	  	<div class="form-group">
									...
									<a href="javascript:;" onclick="jQuery('#modal-6').modal('show', {backdrop: 'static'});" class="btn btn-success col-md-12 col-xs-12 col-sm-12">Add Escalation</a>
                                    	...
                                    	<!--//budget vehicle Found tag---->
                                         <div id="model_div_budget"></div>
       		 	...
       		 	<div id="buy_used_car">
     			  <p class="text-center" style="font-size: 15px;"><b>Buy Used Car Details</b></p>
     			 			<div class="form-group">
         					...
         					<div class="col-md-12 col-sm-12 col-xs-12" >
                          	...
                          	<div class="form-group">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Budget From: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                          
                          	<select name="budget_from" id="budget_from" class="form-control" required tabindex="20" onchange="select_budget();">
										<option value="">Please Select  </option>
                     	  ...
                     	  <div class="form-group">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Budget To: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                        
                          	<select name="budget_to" id="budget_to" class="form-control" required tabindex="21" onchange="select_budget();">
                  ...
                  <div id="model_div_budget"></div>
                        <div class="form-group">
                                     ...
                                     <div class="col-md-4">
                                     	  <div  id="exchange" >
                                     	  	  <p class="text-center" style="font-size: 15px;"><b>Sell Used Car Details</b></p>
                    ...
                    <div class="form-group">
                      <label class="control-label  col-md-12 col-sm-12 col-xs-12" for="first-name">Manufacturing Year: </label>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                        <label class="control-label c col-md-12 col-sm-12 col-xs-12" for="first-name">Any Accidental Claim: </label>
                         <div class=" col-md-12 col-sm-12 col-xs-12">
                         	     	<input type="radio" value="Yes" id="claim1"  name="claim">   Yes
                           	<input type="radio" value="No" id="claim2"  name="claim">   No
                        ...
                        <div class="form-group">
                         <label class="control-label col-md-7 col-sm-7 col-xs-12" >Interested in Finance:</label>
                           <div class="col-md-5 col-sm-5 col-xs-12" style="margin-top: 10px;">
                           	...
                           	<input type="radio" value="No" id="interested_in_finance2"  name="interested_in_finance">&nbsp;&nbsp; No &nbsp;&nbsp;
                         ...
                         <label class="control-label col-md-7 col-sm-7 col-xs-12" >Interested in Accessories:</label>
                           <div class="col-md-5 col-sm-5 col-xs-12" style="margin-top: 10px;">
                           	...
                           	<input type="radio" value="No" id="interested_in_accessories2"  name="interested_in_accessories">&nbsp;&nbsp; No &nbsp;&nbsp;
                         ...
                         <label class="control-label col-md-7 col-sm-7 col-xs-12" >Interested in Insurance:</label>
                           <div class="col-md-5 col-sm-5 col-xs-12" style="margin-top: 10px;">
                           	...
                           	<input type="radio" value="No" id="interested_in_insurance2"  name="interested_in_insurance">&nbsp;&nbsp; No &nbsp;&nbsp;
                         ...
                         <label class="control-label col-md-7 col-sm-7 col-xs-12" >Interested in EW:</label>
                           <div class="col-md-5 col-sm-5 col-xs-12" style="margin-top: 10px;font-size: 13px;">
                           	<input type="radio" value="Yes" id="interested_in_ew1" name="interested_in_ew">&nbsp;&nbsp; Yes &nbsp;&nbsp;
                           	<input type="radio" value="No" id="interested_in_ew2"  name="interested_in_ew">&nbsp;&nbsp; No &nbsp;&nbsp;
                              ...
                              <select name="appointment_type" id="appointment_type" class="form-control" tabindex="10"  onchange="check_appointment_details();">
										<option value="">Please Select  </option>
										  ...
										  <div class="form-group">
                                                ...
                                                <input type="text"  placeholder="Enter Appointment Date" id="appointment_date" name='appointment_date'  class="appointment_date form-control" autocomplete="off"  style="cursor:default;" tabindex="11" />
                        		...
                        		<?php
                        		 ...
                        		 if($lead_detail[0]->assign_to_dse_tl!=0){
  								 ...
  								 <label  style="color:#FF0000;"  class="col-md-12">	Lead Already Transferred  To Showroom  </label>
  									<?php  }?>		
  									<?php 
  									var_dump($lead_detail[0]);
  									echo "saniya--".$lead_detail[0]->transfer_process;
  									if($lead_detail[0]->transfer_process!=''){?>
