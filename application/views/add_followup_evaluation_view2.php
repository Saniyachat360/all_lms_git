                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Any Accidental Claim: </label>
                         <div class="col-md-8 col-sm-8 col-xs-12">
                            <select name="claim" id="claim" class="form-control" tabindex="23" >
                          ...
                          <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Evaluation within days: </label>
                          <div class="col-md-8 col-sm-8 col-xs-12">
                           ...
                           <div class="form-group">
                         <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Quoted Price: </label>
                          <div class="col-md-8 col-sm-8 col-xs-12">
                                 ...
                                 <div  class="form-group" id="lead_status">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Current Process Lead Status:</label>
                                        <div class="col-md-8 col-sm-8 col-xs-12" style="margin-top: 5px;">
                                        	 <input type="radio" value="Close" name="lead_status"> Close &nbsp;&nbsp;
							<input type="radio" value="Continue" name="lead_status"> Continue<br>
