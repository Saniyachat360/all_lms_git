...
<style>
  ...
  .login-page .login-content {
		...
		<div class="login-container">
			<div class="login-header login-caret" style="padding: 20px">
				<div class="login-content">
					<a href="#" class="logo"><!--<h1 style="color:white;"><i class="" style="font-size: 26px;"></i>LMS Login</h1>--><!--<img src="<?php echo base_url();?>assets/images/Autovista_white_logo.png">--><p style="color:#fff;font-size: 20px">Sign Up</p> </a>
	...
	<input type="hidden" required readonly="" class="form-control" value="<?php echo $maxIdNew;?>" id="empId" name="empId">
						...
						<div class="form-group col-md-12">
							...
							<a href="#" onclick="send_otp()" style="text-decoration: underline;">Send OTP</a>
...
<div id="cpassword_error"  style="color:red;text-align: left;"></div>
		...
		<div class="col-md-12" style="background-color: #154a87;padding: 25px;text-align: center;">
	<p style="color:white;">
