...
<?php echo $this -> session -> flashdata('message'); ?>
		   ...
		   <h1 style="text-align:center; ">Edit Next Action Status</h1>
<div class="col-md-12" >
     ...
     <div class="panel-body">
                ...
                <?php
                     ...
                     <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                         <div class="col-md-12">
                         	<div class="form-group">
                              ...
                              <div class="form-group">
                                                  <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Next Action Status: 
                                            </label>
                                                <div class="col-md-5 col-sm-5 col-xs-12">
                                                  <input type="text" required onkeypress="return alpha(event)" autocomplete="off" class="form-control" id="naction_name" value="<?php echo $fetch->nextActionName;?>" name="naction_name" >
                                            <input type="hidden" class="form-control" value="<?php echo $fetch->nextActionId;?>" id="naction_id" name="naction_id" >
                                            </div>
                                                               </div>
                    ...
                    <button type="submit" class="btn btn-success col-md-12 col-xs-12 col-sm-12">Update</button>
                        ...
                        <div class="col-md-2">
                            <input type='reset' class="btn btn-primary col-md-12 col-xs-12 col-sm-12" value='Cancel' onclick="window.location='<?php echo site_url();?>Next_action'">
