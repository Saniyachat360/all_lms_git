...
<div class="row" >
	...
	if($insert[5]==1)
	{?>
	<h1 style="text-align:center; ">Add Sub Lead Source</h1>
	<div class="col-md-12" >
					...
					<div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
						<div class="col-md-12">
							...
							<?php	} ?>
								...
								<div class="col-md-5 col-sm-5 col-xs-12">
							<input type="text" name="sub_lead_source" class="form-control" required=""  placeholder="Enter Sub Lead Source">
								</div>
							</div>
						</div>
					</div>
		...
		<div class="table-responsive"  >
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php echo $fetch -> sub_lead_source_name; ?>
					</td>
					<td>
						<?php echo $fetch -> process_name; ?>
					</td>					<?php					if($fetch->sub_lead_source_status =='Deactive')					{						?>						<td>						Deactivate						</td>						<?php					}					else {
					 if($modify[5]==1 || $delete[5]==1)  {
					?>
					<td>
					<?php if($modify[5]==1) {
					?>
					<a href="<?php echo site_url(); ?>Add_leadsource/edit_sub_lead_source/<?php echo $fetch -> sub_lead_source_id; ?>">Edit </a> &nbsp;&nbsp;
					<?php }
						if($delete[5]==1) {
					?>
					<a onclick="return getConfirmation();" href="<?php echo site_url(); ?>Add_leadsource/delete_sub_lead_source/<?php echo $fetch -> sub_lead_source_id; ?>">Delete </a>
					<?php } ?>
					</td>
					<?php } }?>
				</tr>
