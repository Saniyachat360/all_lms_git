						 ...
						 -->
						  ...
						  <td>
						  	...
						  	<?php 
								$t = ' ( ';
								$i=0;
								foreach($campaign_today_followup_m as $row){
								if ($i == 0) {
								$t = $t . "enq_id = '" . $row -> enq_id . "'";
								} else {
								$t = $t . " or enq_id ='" . $row -> enq_id . "'";
								...
								$st = $t . ')';	 
								$campaign_today_followup_m1=count($campaign_today_followup_m);
								 if($campaign_today_followup_m1!=0)
								  {?>
								 <input type="hidden" id="cse_pending_lead" value="<?php echo $st; ?>">
							<a href="#" onclick= "test('campaign_today_followup_m');">
								<?php } 
							echo $campaign_today_followup_m1;
						  ?>
					...
					<!--	 <td>
						  ...
						  <td>
						  	...
						  	<?php 
								...
								$st = $t . ')';	 
								$campaign_today_followup_m=count($campaign_today_followup_m);
								 if($campaign_today_followup_m!=0)
								  {?>
								 <input type="hidden" id="cse_pending_lead" value="<?php echo $st; ?>">
							<a href="#" onclick= "test('campaign_today_followup_m');">
								<?php } 
							echo $campaign_today_followup_m;
						  ?>
