...
<div class="row" >
	...
	if($insert[5]==1)
	{?>
	<h1 style="text-align:center; ">Add Mail Template</h1>
	<div class="col-md-12" >
			...
			<div class="panel-body">
				<form action="<?php echo $var; ?>" method="post" enctype="multipart/form-data">
                  ...
                  autocomplete="off" class="form-control" >
							...
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Mail Type: </label>
								<div class="col-md-5 col-sm-5 col-xs-12">
...
<div class="row" >
	<div class="col-md-12">
        ...
        if(isset($modify[5]))
        {if($modify[5]==1){?>
                <a href="<?php echo site_url(); ?>/mail_template_cron/template_edit/<?php echo $row ->t_id; ?>">Edit </a><?php }  } ?> &nbsp;&nbsp; <!--go to function edit_user in add_my user_controller when click on edit link (3)-->
                <?php if(isset($delete[5]))
        {if($delete[5]==1){?>
                <a onclick="return getConfirmation()" href="<?php echo site_url(); ?>/mail_template_cron/template_delete/<?php echo $row ->t_id; ?>">Delete </a>
                 <?php }  } ?>
          <?php }
      else
      {
            ?>
            <a onclick="return getActionConfirmation()" href="<?php echo site_url(); ?>/mail_template_cron/template_action/<?php echo $row ->t_id; ?>">Active</a> &nbsp;&nbsp;
            <?php
      }
    ?></td>
