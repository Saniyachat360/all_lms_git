...
function test()
{
	...
	window.open(ur+"website_leads/ebook_leads_download/?payment_fromdate="+payment_fromdate+"&payment_todate="+payment_todate+"&payment_status="+payment_status+"&lead_source="+lead_source,"_blank");
}
</script>    
								<script>
