...
<div >
		...
		<h1 style="text-align:center;">Follow Up Details</h1> <br/>
 	 	...
 	 	<div class="panel panel-primary">
     		...
     		<div class="panel-body">
     			<div class="col-md-6">
                                      <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" >Loan Product Type:</label>
                                         	<div class="col-md-8 col-sm-8 col-xs-12">
   ...
   <div class="panel panel-primary">
     		<div class="panel-body">
     			<div class="col-md-6">
     				    <div class="form-group" >
                                    		<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">New Bank: </label>
                                   			<div class="col-md-8 col-sm-8 col-xs-12">
     	 ...
     	 <div class="panel panel-primary">
     		<div class="panel-body">
     			<div class="col-md-6">
                                      ...
                                      <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" >Customer Status:</label>
                                         	<div class="col-md-8 col-sm-8 col-xs-12">
                                     ...
                                     <div class="col-md-6">
                                       <div class="form-group">
                                        ...
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" >Disburse Amount:</label>
                                         	<div class="col-md-8 col-sm-8 col-xs-12">
                                                <input type="text" placeholder="Enter Disburse Amount " onkeypress="return isNumberKey(event)" name='disburse_amount' id="disburse_amount" class=" form-control" oninput="calculatePayout()" />
                                         	</div>
                                      </div>
                                      <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" >Payout Percent:</label>
                                         	<div class="col-md-8 col-sm-8 col-xs-12">
                                                <input type="text" placeholder="Enter Payout percent" onkeypress="return isNumberKey(event)" name='payout_percent' id="payout_percent" class="form-control" oninput="calculatePayout()"/>
                                         	</div>
                                      </div>
                                      <div class="form-group">
                                        <label class="control-label col-md-4 col-sm-4 col-xs-12" >Payout Amount:</label>
                                         	<div class="col-md-8 col-sm-8 col-xs-12">
                                                <input type="text" placeholder="Enter Payout Amount" onkeypress="return isNumberKey(event)" name='payout_amount' id="payout_amount" class="form-control" readonly/>
                                         	</div>
                                      </div>
                                      <div class="form-group">
...
function isNumberKey(evt) {
	...
	function calculatePayout() {
				var disburseAmount = parseFloat(document.getElementById('disburse_amount').value) || 0;
				var payoutPercent = parseFloat(document.getElementById('payout_percent').value) || 0;
				var payoutAmount = (disburseAmount * payoutPercent)/100;
				document.getElementById('payout_amount').value = payoutAmount.toFixed(2);
			}
