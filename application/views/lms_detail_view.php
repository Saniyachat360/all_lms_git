	...
	function get_detail_followup()
{
	alert("hii");
	var t='<?php echo $enq;?>';
	var a='<?php if(isset($select_data)){ echo $select_data[0]->enq_id; } ?>';
	//alert(t);
   ...
   if($insert[9]==1)	   
	{
		if($_SESSION['process_id']==5)
		{
			$followup_url='add_followup_accessories';
		}
		else if($_SESSION['process_id']==4)
		{
			$followup_url='add_followup_service';	
		}
	
		else if($_SESSION['process_id']==1)
		{
			$followup_url='add_followup_finance';			
		}
		else if($_SESSION['process_id']==6)
		{
			$followup_url='add_followup_new_car';
			
		}
		else if($_SESSION['process_id']==7)
		{
			$followup_url='add_followup_used_car';
		...
		else if($_SESSION['process_id']==8)
		{
			...
			{
				$followup_url='add_followup_evaluation_tracking';
			}
			else {
				$followup_url='add_followup_evaluation';
			}
		}
		else
		{
			$followup_url='add_followup';			
		}
		?>
		<a id="sub" href="<?php echo site_url(); echo $followup_url.'/detail/'.$details[0]->enq_id; ?>/<?php echo $enq;?>"  class="pull-right" style="margin-top:-40px" >
...
<?php } ?>
     ...
     <div class="panel-body">
				...
				<?php if($_SESSION['process_name']=='New Car' || $_SESSION['process_name']=='POC Sales')
					{?>
				...
				<?php if($_SESSION['process_name']=='POC Sales')
					{?>
				...
				<?php } ?>
               	...
               	<?php if($_SESSION['process_name']=='Finance' && $_SESSION['process_id']=='1')
												{?>
  ...
  <div class="form-group">
	 ...
	 <div class="form-group">
                  ...
                  <br>
					 ...
					 <?php } ?> 
					     	<?php if($_SESSION['process_name']=='Service' && $_SESSION['process_id']=='4')
												{?>
													    <div class="panel panel-primary">
     ...
     <div class="panel-body">
			...
			<h3 class="text-center">Other Details</h3>
						...
						<?php  } ?>
			<?php if($_SESSION['process_name']=='Accessories' && $_SESSION['process_id']=='5' )
												{
