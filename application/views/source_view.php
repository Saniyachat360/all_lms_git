...
<h1 style="text-align:center; ">Source Wise Report</h1>
...
<div class="col-md-12">
    <div class="panel panel-primary">
        <div class="panel-body">
            <form action="<?php echo site_url(); ?>Source/source_view" id="filterForm" method="POST">
                <div class="form-group col-md-12">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding: 20px;">
                        <select class="filter_s col-md-12 col-xs-12 form-control" name="source" id="source" placeholder="Please Select Source">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#filterForm').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url(); ?>Source/filterSubmissionProcesses',
                data: $(this).serialize(),
                dataType: 'json',
        ...
        $('#Downloads').click(function() {
            ...
            XLSX.writeFile(wb, 'Source_Report.xlsx');
        });
    });
