...
<div class="row" >
	...
	if($insert[5]==1)
	{?>
	<h1 style="text-align:center; ">Edit Professional Type</h1>
	<div class="col-md-12" >
		<div class="panel panel-primary">
			<div class="panel-body">
				...
				<form action="<?php echo $var; ?>" method="post">
						...
						<div class="col-md-12">
								...
								<div class="col-md-8 col-sm-5 col-xs-12">
									<input type="text"  onkeypress="return alpha(event)" autocomplete="off" class="form-control" id="reason_name" required name="reason_name"
										value="<?php echo $fetch->p_type_name ;?>"
									>
								</div>
							</div>
					...
					<input type="hidden" class="form-control" value="<?php echo $fetch->p_type_id;?>"  name="login_status_id" >
					<div class="form-group">
