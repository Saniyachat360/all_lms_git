...
<div class="row" >
	...
	if($insert[5]==1)
	{?>
	<h1 style="text-align:center; ">Edit Employment Type</h1>
	<div class="col-md-12" >
		<div class="panel panel-primary">
			<div class="panel-body">
				...
				<form action="<?php echo $var; ?>" method="post">
					...
					<input type="hidden" class="form-control" value="<?php echo $fetch->e_id;?>"  name="login_status_id" >
					<div class="form-group">
