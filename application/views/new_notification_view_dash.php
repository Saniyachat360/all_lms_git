  ...
  <div class="row" >
	<h1 style="text-align:center; ">Home Visit, Showroom Visit, Test Drive</h1>
	<div class="col-md-12" >
...
// 		alert('Hi');
		...
		//Create Loader
		    ...
		    <?php if($this->session->userdata('process_id')==9){
		    	$ajaxurl=site_url()."Notification_dash/all_notification_complaint_counts";
		    }else{
		    	$ajaxurl= site_url()."Notification_dash/all_notification_counts";
		    }
		    ?>
