...
<div class="row" >
	...
	if($insert[0]==1)
	{?>
	<h1 style="text-align:center; ">Add Login Status</h1>
	<div class="col-md-12" >
		...
		<div class="table-responsive"  >
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php echo $fetch -> login_status_name; ?>
					</td>
					...
					<?php if($modify[0]==1) {
					?>
					<a href="<?php echo site_url(); ?>login_status/edit_l_status/<?php echo $fetch -> login_status_id; ?>">Edit </a> &nbsp;&nbsp;
					<?php }
						if($delete[0]==1) {
					?>
					<a onclick="return getConfirmation();" href="<?php echo site_url(); ?>login_status/delete_l_status/<?php echo $fetch -> login_status_id; ?>">Delete </a>
					<?php } ?>
					</td>
					<?php }
					} ?>
