...
<div class="row" >
	...
	if($insert[4]==1)
	{?>
	<h1 style="text-align:center; ">Add Scheme</h1>
	<div class="col-md-12" >
					...
					<div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-md-8 col-sm-5 col-xs-12">
									<input type="text"  onkeypress="return alpha(event)" autocomplete="off" class="form-control" id="scheme_name" required name="scheme_name"></textarea>
								</div>
							</div>
							<div class="form-group">
	...
	<div class="col-md-12">
		...
		<div class="table-responsive"  >
			...
			<tbody>
				<?php
				$i=0;
				foreach($select_scheme as $fetch)
				{
				$i++;
				?>
				...
				<tr>
					...
					<td>
						<?php echo $fetch -> scheme_name; ?>
					</td>
					<td>
						<?php echo $fetch -> scheme_desc; ?>
					</td>
						<td>
					...
					if($modify[4]==1 || $delete[4]==1)  {
					?>
					<td>
					<?php if($modify[4]==1) {
					?>
					<a href="<?php echo site_url(); ?>scheme/edit_scheme/<?php echo $fetch -> scheme_id; ?>">Edit </a> &nbsp;&nbsp;
					<?php }
						if($delete[4]==1) {
					?>
					<a onclick="return getConfirmation();" href="<?php echo site_url(); ?>scheme/delete_scheme/<?php echo $fetch -> scheme_id; ?>">Delete </a>
					<?php } ?>
					</td>
					<?php }
					} ?>
