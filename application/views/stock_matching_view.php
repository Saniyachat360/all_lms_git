...
?>  
		...
		{
			?>
			 <a class='pull-right'  href="<?php echo site_url('')?>unassign_leads/downloadLeads?id=<?php echo $id;?>&enq=<?php echo $enq;?>&role=<?php echo $role ; ?>&name=<?php if(isset($name)){ echo $name; }?>" target="_blank" >
...
else if($enq == 'Stock Matching'){
	$url='stock_mactching/leads/';
	$total_record=$stock_visit_count_lead[0]->count_lead;
}
else{
