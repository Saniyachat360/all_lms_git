...
<div class="row" >
	<div class="col-md-12">
        ...
        if(isset($modify[5]))
        {if($modify[5]==1){?>
                <a href="<?php echo site_url(); ?>/mail_template/template_edit/<?php echo $row ->t_id; ?>">Edit </a><?php }  } ?> &nbsp;&nbsp; <!--go to function edit_user in add_my user_controller when click on edit link (3)-->
                <?php if(isset($delete_master[5]))
        {if($delete[5]==1){?>
                <a onclick="return getConfirmation()" href="<?php echo site_url(); ?>/mail_template/template_delete/<?php echo $row ->t_id; ?>">Delete </a>
                 <?php }  } ?>
          <?php }
      else
      {
            ?>
            <a onclick="return getActionConfirmation()" href="<?php echo site_url(); ?>/mail_template/template_action/<?php echo $row ->t_id; ?>">Active</a> &nbsp;&nbsp;
            <?php
      }
    ?></td>
