<?php
    ...
    */
    ...
    class Easebuzz{
        ...
        private $MERCHANT_KEY = "2C0DE0SV91";
        private $SALT = "5VNXEGR9PJ";
        private $ENV = "prod";
        ...
        */
        ...
        public function easycollectPaymentAPI($params, $redirect=True){
            // include file
            include_once('easycollect.php');
            ...
            return easycollect_payment($params, $redirect, $this->MERCHANT_KEY, $this->SALT, $this->ENV);
        }
