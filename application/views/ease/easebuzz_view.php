...
//  $this -> load -> view('easebuzz/easebuzz_payment_gateway.php');
...
// second way
echo   $apiname = trim(htmlentities($api_name, ENT_QUOTES));
//print_r($_POST);
// third way
...
if ($apiname === "easycollect_payment") {  

    // echo "Hii easycollect";
    // exit;


    $result = $easebuzzObj->easycollectPaymentAPI($_POST);
        
    easebuzzAPIResponse($result);
}
else if ($apiname === "initiate_payment") {  
