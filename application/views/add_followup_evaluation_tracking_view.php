...
function check_values()
{
	...
	if(photo_uploaded=='Yes'){
		document.getElementById("photo_uploaded1").checked = true;
	  
	}else{
		document.getElementById("photo_uploaded2").checked = true;
...
if(isset($insert_poc_purchase_tracking[0])){
if($insert_poc_purchase_tracking[0]==1){?>
     		...
     		<div id="demo-form2" data-parsley-validate class="">
                       ...
                       <section>
						...
						<div class="form-group">
                                      ...
                                      <!--<div class="col-md-8 col-md-offset-3" style="margin-top: 10px">
                              ...
                              <div class="form-group">
                                                ...
                                                <input type="text"  placeholder="Next Follow Up Date" id="followupdate" autocomplete="off" name='followupdate'  class=" form-control" required  style=" cursor:default;" tabindex="7" />
                                           
                                            </div>
                                             <div class="col-md-6 col-sm-6 col-xs-10">
												  
												   <input class="form-control "  data-template="dropdown" id="timet" autocomplete="off" name="followuptime" placeholder="Next Follow Up Time" type="text" tabindex="8"> 
                              ...
                              <select name="appointment_type" id="appointment_type" class="form-control" tabindex="10" onchange="check_appointment_details()">
										<option value="">Please Select  </option>
										  ...
										  <div class="form-group">
                                                  ...
                                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text"  placeholder="Appointment Date" id="appointment_date" name='appointment_date'  class="datett form-control" autocomplete="off"  style="cursor:default;" tabindex="11" />
                                           
                                            </div>
                                             <div class="col-md-6 col-sm-6 col-xs-10">
												  <input class="form-control "  data-template="dropdown" id="appointment_time" name="appointment_time" autocomplete="off" placeholder="Appointment Time" type="text" tabindex="12"> 
													</div>               
                                                               </div>
                             ...
                             <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name"> Car Make: </label>
                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12">
                               ...
                               <div class="form-group"  id="variant_div">
                       			 <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Car Variant: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                       ...
                       <div class="form-group ">
                      <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name"> Registration Year: </label>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="form-group ">
                         <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">KMS: </label>
                          ...
                          <div class="form-group">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">   Type of Vehicle: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                     ...
                     <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name"> Outright\Exchange: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                     ...
                     <div class="col-md-4">
                      <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name"> Old Car Owner Name: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                 ...
                 <div class="form-group">
                        <label class="control-label col-md-6 col-sm-6 col-xs-12">Image Uploaded: </label>
                         <div class="col-md-6 col-sm-6  col-xs-12" style="margin-top: 10px;">                            
                     	 	<input type="radio" value="Yes" id="photo_uploaded1" required="" name="photo_uploaded"> Yes &nbsp;&nbsp;
							<input type="radio" value="No" id="photo_uploaded2" required="" name="photo_uploaded"> No<br>
                          </div>
                     ...
                     <div class="form-group">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">HP: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Finacier Name: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <label class="control-label col-md-6 col-sm-6 col-xs-12">Any Accidental Claim: </label>
                         ...
                         <div class="form-group  ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">   Accidental Details: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                     	  ...
                     	  <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Insurance Type: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
              ...
              <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name"> Insurance company: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                      ...
                      <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name"> Insurance Validity date: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                          <input type="text"  placeholder="Enter Insurance Validity date" id="insurance_validity_date" name='insurance_validity_date'  class="datett form-control"   style=" cursor:default;" tabindex="35"/>
                          ...
                          <div class="form-group ">
                         <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">  Tyre conditon: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                         ...
                         <div class="form-group ">
                         <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Engine work: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                         ...
                         <div class="form-group">
                         <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name"> Body work: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                       ...
                       <div class="col-md-4">
                        <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">   Vehicle Sale Category: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                      ...
                      <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name"> Expected Date of Sale: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                     ...
                     <div class="form-group">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Agent Name: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                      ...
                      <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">  Agent Commision payable: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                     ...
                     <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Refurbish cost Bodyshop: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                     ...
                     <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name" style="padding-left: 0px;
padding-right: 0px;">Refurbish cost Mecahanical: </label>
                         ...
                         <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Refurbish cost Tyre: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                       ...
                       <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Refurbish cost Battery: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                       ...
                       <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Refurbish Other: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                      ...
                      <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Total RF: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
                     ...
                     <div class="form-group ">
                        <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name" > Price (RF & commission): </label>
                          <div class="col-md-12 col-sm-12 col-xs-12"> 
							  ...
							  if(document.getElementById("payment_check").checked==true){
							  	...
							  	document.getElementById("selling_price").disabled = true;
							  		...
							  		document.getElementById("payment_details").style.display = "none";
                                    	...
                                    	<?php  if((isset($insert_poc_purchase_tracking[1]) && $_SESSION['process_id']==8))
				  { 
				  	if($insert_poc_purchase_tracking[1] == '1') {?>
                           <div class="form-group col-md-4"><input type="checkbox" onclick="change_payment()" id="payment_check" name="payment" value="payment" tabindex="51" style="margin-top: 15px">     <label class="control-label col-md-8 col-sm-8 col-xs-12" for="first-name">  Payment Details</label></div>
                      <?php } } ?>
                        <div id="payment_details" style="display: none">
                        	<div class="col-md-4">
                            <div class="form-group">
                         <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name"> Selling Price: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                         ...
                         <div class="form-group ">
                         <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name"> Bought at Price: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <div class="form-group ">
                         <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Bought Date: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-4">
                         <div class="form-group">
                         <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Payment date: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                         ...
                         <div class="form-group">
                         <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Payment mode: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
                         ...
                         <div class="form-group">
                         <label class="control-label col-md-12 col-sm-12 col-xs-12" for="first-name">Payment Made to: </label>
                          <div class="col-md-12 col-sm-12 col-xs-12">
