...
<div class="row" >
  <?php if($_SESSION['process_id']==9)
	{?>
                   <form  action="<?php echo site_url(); ?>new_tracker/tracker_dse_filter_complaint" method="get" onsubmit="return validate_download();">     
     <?php }
	  elseif($_SESSION['process_id']==8)
			...
			{?>
                <form  action="<?php echo site_url(); ?>new_tracker/tracker_sub_poc_purchase_filter" method="get" onsubmit="return validate_download();">     
		<?php }
		else{
			?>
                <form  action="<?php echo site_url(); ?>new_tracker/tracker_dse_filter" method="get" onsubmit="return validate_download();">     
		<?php
		}
				 }
