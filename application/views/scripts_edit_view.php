...
<?php echo $this -> session -> flashdata('message'); ?>
		   ...
		   <h1 style="text-align:center; ">Edit Script</h1>
<div class="col-md-12" >
     ...
     <div class="panel-body">
                ...
                <?php
                     ...
                     <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                         <div class="col-md-12">
                         	<div class="form-group">
                              ...
                              <div class="form-group">
                                                  <label class="control-label col-md-2 col-sm-4 col-xs-12" for="first-name">Script: 
                                            </label>
                                                <div class="col-md-8 col-sm-5 col-xs-12">
                                                  <textarea type="text" required onkeypress="return alpha(event)" autocomplete="off" class="form-control" id="script"  name="script" ><?php echo $fetch->script_desc;?> </textarea>
                                            </div>
                                                               </div>
                                      ...
                                      <input type="hidden" class="form-control" value="<?php echo $fetch->script_id;?>" id="script_id" name="script_id" >
                    ...
                    <button type="submit" class="btn btn-success col-md-12 col-xs-12 col-sm-12">Update</button>
                        ...
                        <div class="col-md-2">
                            <input type='reset' class="btn btn-primary col-md-12 col-xs-12 col-sm-12" value='Cancel' onclick="window.location='<?php echo site_url();?>add_leadsource'">
