...
<div class="row" >
	...
	if($insert[5]==1)
	{?>
	<h1 style="text-align:center; ">Edit SMS Template</h1>
	<div class="col-md-12" >
				...
				<form action="<?php echo $var; ?>" method="post" enctype="multipart/form-data">
                   ...
                   autocomplete="off" value="<?php echo $template_edit[0]->template_name;?>"  class="form-control" >
							...
							<div class="form-group" id='holidaydiv' <?php if($template_edit[0]->holiday_id =='0'){?> style='display:none' <?php } ?> >
								...
								<div class="col-md-5 col-sm-5 col-xs-12">
								<input type="text" id="header" placeholder="Enter Header"  name="header" value="<?php echo $template_edit[0]->header;?>"  autocomplete="off" class="form-control" >
								</div>
							</div>
								<div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Approved: </label>
								<div class="col-md-5 col-sm-5 col-xs-12"><?php $checked=''; if($template_edit[0]->approved=='Yes'){
								$checked='checked';}?>
								<input type="checkbox" id="approved"  name="approved" <?php echo $checked;?>   autocomplete="off" class="form-control" >
								</div>
							</div>
								<div class="form-group">
