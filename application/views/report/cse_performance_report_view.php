...
background-color: #1988b6;
  ...
  <div class="row" >
	...
	<h1 style="text-align:center; ">CSE Performance Report</h1>
			...
			<div class="panel-body">
					<div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
						...
						<div class="form-group col-md-2"  id='todateDiv' style="padding:20px;">
                         ...
                         <button class="btn btn-info col-md-12" onclick="search()"><i class="entypo-search" > Search</i></button>
				<!--<a target="_blank" onclick="test()" >
                            ...
                            <div class=" col-md-2 col-sm-2 col-xs-12" style="padding:20px;">
                                 ...
                                 <a onclick="clear()" > <i class="btn btn-success entypo-ccw col-md-12"> Reset</i></a>
...
function search() {
	...
	else
	{
		src1 ="<?php echo base_url('assets/images/loader200.gif'); ?>";
			...
			$.ajax({
			url:' <?php echo site_url();?>reports/search_performance',
			type:'POST',
