	...
	else
	{
					...
					src1 ="<?php echo base_url('assets/images/loader200.gif'); ?>";
						...
						document.getElementById("blah").appendChild(elem);
								  $.ajax({
								  	url:' <?php echo site_url();?>CSE_reports/search_appointment',
								  	type:'POST',
  ...
  function clear_data() {
								...
								document.getElementById("location_id").innerHTML = '';
								 window.location="<?php echo site_url();?>CSE_reports/appointment_report";
							}
  ...
  <div class="row" >
	<h1 style="text-align:center; ">Appointment Report</h1>
	<div class="col-md-12" >
