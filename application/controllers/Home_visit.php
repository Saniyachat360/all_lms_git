...
class Home_visit extends CI_Controller {
	...
	public function leads() {
		$this -> session();
		$data['enq'] = 'Home Visit Today';
		//get pending attened leads details
		$id_array=$this->input->get('id_array');
		/*if(isset($id_array)){*/
		$data['select_lead'] = $this -> home_visit_model -> select_lead_location_wise();
		$data['home_visit_count_lead'] = $this -> home_visit_model -> select_lead_count_location_wise();
		/*}else{
