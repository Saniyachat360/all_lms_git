...
if($lead_type=='status'){
		...
		?>
							 ...
							 <div class="form-group">
									...
									<input type='hidden'  name='web_count'  class="form-control" value="<?php echo $row->count_lead; ?>">
									</div>
								</div>
	...
	foreach ($pending_followup_leads as $row) {
		...
		?>
				...
				<input type='hidden'  id='all_count' disabled class="form-control" >
			<?php }
	}
public function select_to_location()
{
	$to_location = $this -> assign_cse_transfer_model -> to_location();	
	?>
