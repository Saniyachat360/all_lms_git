...
class Evaluation extends CI_Controller {
	...
	public function leads() {
		$this -> session();
		$data['enq'] = 'Evaluation Today';
		//get pending attened leads details
		$id_array=$this->input->get('id_array');
		/*if(isset($id_array)){*/
		$data['select_lead'] = $this -> evaluation_model -> select_lead_location_wise();
		$data['evaluation_count_lead'] = $this -> evaluation_model -> select_lead_count_location_wise();
		/*}else{
