...
class Notification extends CI_Controller {
		...
		$this->load->model('api_dialer_model');	
	}
	...
	public function index() 
	{
		...
		$data['select_location']=$this->new_notification_model_1->select_location();
			//start dialer code
		$agent_username = $this->session->userdata('agent_username');
		$agent_password = $this->session->userdata('agent_password');
	//	$this->api_dialer_model->getsession_api($agent_username, $agent_password);
		//eof dialer code
		...
		if($location_name!='')
		{
			...
			<div class="col-md-12">
				...
				<tbody>
					...
					<tr>
						<td>5</td>
						<td><b>Pending Followup Leads</b></td>
