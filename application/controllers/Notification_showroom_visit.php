...
ob_start();
class Notification_showroom_visit extends CI_Controller {

		function __construct() {
		parent::__construct();
		$this -> load -> library(array('table', 'form_validation','session'));
		$this -> load -> helper(array('form', 'url'));
		$this->load->model('Notification_showroom_visit_model');	
	...
	public function index() 
	{
		...
		$data['select_location']=$this->Notification_showroom_visit_model->select_location();
		//print_r($data['select_location']);
		//$data['location_data']=$this->Notification_showroom_visit_model->select_all_location_count();
		
		$data['var']=site_url('add_location/insert_location');
		$this->load->view('include/admin_header.php');
		$this -> load -> view('notification_showroom_visit_view.php',$data);
	...
	public function all_notification_counts()
	{
		...
		if($location_name!='')
		{
			$location_data=$this->Notification_showroom_visit_model->location_data($location_name);	
			
			$data['location_data']=$location_data;	
				
			//$location_data=$this->Notification_showroom_visit_model->location_wise_data($location_name);		
				if($user==''){
			$data['select_leads']=$this->Notification_showroom_visit_model->location_data($location_name);	
...
$location_data=$data['location_data']=$this->Notification_showroom_visit_model->location_wise_data($location_name);		
	...
	public function all_notification_complaint_counts()
	{
		...
		if($location_name!='')
		{
			...
			$data['select_leads']=$this->complaint_notification_model->location_data($location_name);	
					...
					<!--<a href="<?php echo site_url();?>Notification_showroom_visit/send_mail/<?php echo $location_name;?>" class="btn btn-success pull-right">
								Notify GM
					</a>-->
